      ...
      <nav class="navbar navbar-default navbar-fixed-top menu">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index-register.html"><img src="images/" alt="logo/Organization Name" /></a>
          </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
              <!-- <li class="dropdown">
                <a href="index.html" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Home <span><img src="images/down-arrow.png" alt="" /></span></a>
			  ...
			  <li class="dropdown"><a href="index-register.html">Register/login</a></li>
    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <ul class="nav-news-feed">
              <li><i class="icon ion-ios-paper"></i><div><a href="newsfeed.html">Validated Users</a></div></li>
              <li><i class="icon ion-ios-people"></i><div><a href="newsfeed-people-nearby.html">Unvalidated Users</a></div></li>
              <!-- <li><i class="icon ion-ios-people-outline"></i><div><a href="newsfeed-friends.html">Validated Users</a></div></li> -->
           ...
           <!--chat block ends-->
            ...
            <div class="container mt-5"><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/path/to/uploaded/photos/9M0B3970.JPG" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Sambhav_Anand 8527510816</h5><p>Email: </p><a href="newsfeed-friends.php?id=" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/path/to/uploaded/photos/slider 2.jpg" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Sambhav_Anand 8527510816</h5><p>Email: </p><a href="newsfeed-friends.php?id=" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/path/to/uploaded/photos/slider 2.jpg" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">sambhav109 8527510816</h5><p>Email: </p><a href="newsfeed-friends.php?id=" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e02a5347959.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Sambhav Anand</h5><p>Email:  sambhavanand09@gmail.com</p><a href="newsfeed-friends.php?id= sambhavanand09@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e02af0767bb.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Sambhav Anand</h5><p>Email:  sambhavanand09@gmail.com</p><a href="newsfeed-friends.php?id= sambhavanand09@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e02b013afc5.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Sambhav Anand</h5><p>Email:  sambhavanand09@gmail.com</p><a href="newsfeed-friends.php?id= sambhavanand09@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e2ea1ae24af.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Manpreet SAINI</h5><p>Email:  manpreetsingh@usa.com</p><a href="newsfeed-friends.php?id= manpreetsingh@usa.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e7129e8e408.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e712e6b6869.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e7136b06183.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e7185c43af3.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e7770ff1f74.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e7782f505d3.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e80226bd528.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dev Kumar</h5><p>Email:  a@gmail.com</p><a href="newsfeed-friends.php?id= a@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65e9fd8346d5f.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">rahul sinha</h5><p>Email:  rahulraj@gmail.com</p><a href="newsfeed-friends.php?id= rahulraj@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65ea0d21e8815.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title"> </h5><p>Email:  </p><a href="newsfeed-friends.php?id= " class="btn btn-primary mt-2">Check Details</a></div></div></div></div><div class="row mb-4"><div class="col-md-4"><div class="card"><img src="images/user_65ea1086d3109.png" class="card-img-top" alt="User Photo"><div class="card-body"><h5 class="card-title">Dhananjay Verma</h5><p>Email:  dhananjaykumarverma088@gmail.com</p><a href="newsfeed-friends.php?id= dhananjaykumarverma088@gmail.com" class="btn btn-primary mt-2">Check Details</a></div></div></div></div></div>            <!-- Post Content
            ================================================= -->
