...
if ($result->num_rows > 0) {
    ...
    echo '<p><strong>City:</strong> ' . $userData['city'] . '</p>';
    ...
    echo '<div class="card">';
    echo '<div class="card-header bg-primary text-white">';
    echo '<h3>Management Information</h3>';
    echo '</div>';
    echo '<div class="card-body">';
    
    // Display management information
    echo '<p><strong>Firstname:</strong> ' . $userData['firstname1'] . '</p>';
    echo '<p><strong>Lastname:</strong> ' . $userData['lastname1'] . '</p>';
    echo '<p><strong>Firstname:</strong> ' . $userData['firstname2'] . '</p>';
    echo '<p><strong>Lastname:</strong> ' . $userData['lastname2'] . '</p>';
    // echo '<p><strong>Country Code :</strong> ' . $userData['countrycode2'] . '</p>';
    echo '<p><strong>Phone Number :</strong> ' . $userData['phone2'] . '</p>';
